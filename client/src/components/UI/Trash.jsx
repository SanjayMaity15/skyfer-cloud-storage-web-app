							...
							return (
								<div className="bg-white p-2 flex items-center justify-between">
									...
									<div className="flex items-center gap-5 text-sm">
										<button
											className="bg-green-100 px-4 py-1 rounded-full text-green-700 border cursor-pointer"
											onClick={() =>
												handleRecoverFile(file._id)
											}
										>
											{loading1 ? (
												<ButtonLoader text="Recovering" />
											) : (
												"Retrive"
											)}
										</button>
